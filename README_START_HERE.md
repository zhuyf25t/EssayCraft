...
- a Next.js/TypeScript/Tailwind EssayCraft scaffold,
...
Codex cannot access this zip unless you push its contents to the repository first. Seed the GitHub repo before starting autonomous implementation.
